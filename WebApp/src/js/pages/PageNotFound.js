  ...
  render() {
    return (
      <div  className="pagenotfound">
        <Container>
          <h1 className="bigHeader" >Ups... du bist zu weit gelaufen.<br />Halt dich an den Plan!<br /></h1>
          <h1 className="smallHeader" style={{paddingTop: '50px'}}>Diese Seite existiert nicht.<br />
          <Nav.Link href="#home">
